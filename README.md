...
| [Bridge (bridge.xyz)](https://apidocs.bridge.xyz/get-started/introduction/quick-start/setting-up-webhooks) | [`bridge-xyz-webhooks`](skills/bridge-xyz-webhooks/) | Verify Bridge (bridge.xyz) webhook signatures (`X-Webhook-Signature`, RSA-SHA256 with a per-endpoint public key), handle customer, kyc_link, transfer, and virtual_account events |
