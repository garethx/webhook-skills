...
| [Fireflies](https://docs.fireflies.ai/graphql-api/webhooks) | [`fireflies-webhooks`](skills/fireflies-webhooks/) | Verify Fireflies.ai webhook signatures (`x-hub-signature`, HMAC-SHA256 hex, no prefix), handle the `Transcription completed` event |
...
| [Recharge](https://docs.getrecharge.com/docs/webhooks-overview) | [`recharge-webhooks`](skills/recharge-webhooks/) | Validate Recharge webhooks (`X-Recharge-Hmac-Sha256` — plain SHA-256 of secret + body, not HMAC), handle subscription, charge, and order events |
