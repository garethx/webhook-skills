...
| [Statsig](https://docs.statsig.com/integrations/event_webhook) | [`statsig-webhooks`](skills/statsig-webhooks/) | Verify Statsig webhook signatures (HMAC-SHA256, `X-Statsig-Signature` over `v0:timestamp:body`), handle exposure, config change, and custom events |
