# Treezor Webhooks - Next.js Example

Minimal example of receiving Treezor webhooks with signature verification using the
Next.js App Router.
...
3. Add your Treezor webhook secret to `.env.local`
