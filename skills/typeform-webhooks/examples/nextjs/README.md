# Typeform Webhooks - Next.js Example

Minimal example of receiving Typeform webhooks with signature verification using the Next.js App Router.
...
3. Add your Typeform webhook secret to `.env.local` as `TYPEFORM_WEBHOOK_SECRET`.
