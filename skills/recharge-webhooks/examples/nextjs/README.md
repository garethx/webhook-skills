# Recharge Webhooks - Next.js Example

Minimal example of receiving Recharge webhooks with signature verification using the Next.js App Router.
...
The webhook route is served at http://localhost:3000/webhooks/recharge
