# Cisco Meraki Webhooks - Next.js Example

Minimal example of receiving Cisco Meraki Dashboard webhook alerts in a Next.js
App Router route handler and verifying the `sharedSecret` in the request body.
...
The webhook is served at `POST http://localhost:3000/webhooks/meraki`
(`app/webhooks/meraki/route.ts`).
