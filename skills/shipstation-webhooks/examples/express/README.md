# ShipStation Webhooks - Express Example

Minimal example of receiving ShipStation V1 webhooks with Express.
...
Use the generated HTTPS URL (append `?token=YOUR_SECRET`) as the `target_url` when subscribing, then
import or ship an order in ShipStation.
