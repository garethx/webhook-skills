# Twitch Webhooks - Next.js Example

Minimal example of receiving Twitch EventSub webhooks in a Next.js App Router
route handler, with signature verification, the verification-challenge
handshake, and event dispatch.
...
The webhook handler lives at `app/webhooks/twitch/route.ts` and is served at
`POST http://localhost:3000/webhooks/twitch`.
...
The tests drive the route handler with real Twitch signatures (HMAC-SHA256 over
