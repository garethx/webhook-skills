...
3. Add your WeChat Pay platform public key (`WECHAT_PAY_PUBLIC_KEY`) and 32-character APIv3 key (`WECHAT_PAY_API_V3_KEY`) to `.env`. Optionally set `WECHAT_PAY_PLATFORM_SERIAL`.
