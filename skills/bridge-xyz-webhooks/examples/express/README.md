# Bridge (bridge.xyz) Webhooks - Express Example

Minimal example of receiving Bridge webhooks with RSA-SHA256 signature verification.
...
3. Add the endpoint's `public_key` (from the Bridge webhook create/update API
   ...
   `\n` escapes — the app converts them back to newlines.
