...
- [clerk-webhooks](https://github.com/hookdeck/webhook-skills/tree/main/skills/clerk-webhooks) - Clerk uses Standard Webhooks (with `svix-*` header aliases)
- [resend-webhooks](https://github.com/hookdeck/webhook-skills/tree/main/skills/resend-webhooks) - Resend uses Standard Webhooks for email events
- [knock-webhooks](https://github.com/hookdeck/webhook-skills/tree/main/skills/knock-webhooks) - Knock uses Standard Webhooks for notification events
- [openai-webhooks](https://github.com/hookdeck/webhook-skills/tree/main/skills/openai-webhooks) - OpenAI uses Standard Webhooks for batch/eval events
- [stripe-webhooks](https://github.com/hookdeck/webhook-skills/tree/main/skills/stripe-webhooks) - Stripe payment webhooks (different signing scheme)
